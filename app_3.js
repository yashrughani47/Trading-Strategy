...
// Fixed version with removed problematic loading overlays
...
class TradingJournalPro {
  ...
  refreshPrices() {
    // Simulate price refresh without hanging loading overlay
    this.livePrices.forEach((price, symbol) => {
  ...
  refreshAllData() {
    // Refresh data immediately without problematic loading overlay
    this.refreshPrices();
    this.updateLastRefreshTime();
